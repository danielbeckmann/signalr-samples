...
namespace signalrdemo
{
    public class ChatHub : Hub
    {
        ...
        {
            return Clients.All.SendAsync("broadcast", "Admin", $"{Context.ConnectionId} Connected");
        }

        public override Task OnDisconnectedAsync(Exception exception)
        {
            return Clients.All.SendAsync("broadcast", "Admin", $"{Context.ConnectionId} Disconnected");
        }
    }
}
